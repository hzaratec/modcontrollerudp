...
void sha_init(SHA_INFO *sha_info, long int i)
{
    sha_info->digest[0] = 0x67452301L + i;
    sha_info->digest[1] = 0xefcdab89L + i;
    sha_info->digest[2] = 0x98badcfeL + i;
    sha_info->digest[3] = 0x10325476L + i;
    sha_info->digest[4] = 0xc3d2e1f0L + i;
...
void sha_comm(SHA_INFO *sha_info, char* ip)
{
    int sock;
